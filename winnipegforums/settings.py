"""
Django settings for winnipegforums project.
...
ALLOWED_HOSTS = ['mindstorm.pythonanywhere.com']
...
ROOT_URLCONF = 'winnipegforums.urls'
...
WSGI_APPLICATION = 'winnipegforums.wsgi.application'
